/*
 * Pertemuan 1 — Task A3: Terjemahkan Pseudocode ke Kode C
 ...
 *   - Compile: gcc 01_Task_A3.c -o 01_Task_A3
 *   - Jalankan: ./01_Task_A3  (Linux/Mac)  atau  01_Task_A3.exe  (Windows)
 */
...
int main() {
    ...
    /* (C1) Deklarasi variabel yang sesuai untuk nilai 0-100 */


    /* (C2) Cetak: "Masukkan nilai kamu (0-100): " */


    /* (C3) Baca input ke variabel nilai */
